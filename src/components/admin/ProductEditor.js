  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Apple MacBook Specific Fields - Shows when brand is Apple */}
        {(formData.category === 'laptop' || formData.category === 'workstation') && formData.brand?.toLowerCase() === 'apple' && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  {filterOptions.appleModels?.map(model => (
              ...
              <div>
                ...
                >
                  ...
                  {filterOptions.appleProcessors?.map(proc => (
                    <option key={proc} value={proc}>
                      {proc}
                    </option>
                  ))}
              ...
              <div>
                ...
                >
                  ...
                  {filterOptions.appleDisplay?.map(display => (
              ...
              <div>
                ...
                >
                  ...
                  {filterOptions.appleGraphics?.map(gpu => (
              ...
              <div>
                ...
                >
                  <option value="">Select Condition</option>
                  {filterOptions.appleCondition?.map(cond => (
              ...
              <div>
                ...
                >
                  ...
                  {filterOptions.appleScreenSize?.map(size => (
                    <option key={size} value={size}>
                      {size}
                    </option>
                  ))}
              ...
              <div>
                ...
                >
                  ...
                  {filterOptions.appleRam?.map(ram => (
              ...
              <div>
                ...
                >
                  ...
                  {filterOptions.appleStorage?.map(storage => (
