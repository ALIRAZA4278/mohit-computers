...
-- Insert DDR4 RAM options (6th to 12th Generation)
INSERT INTO laptop_upgrade_options (
  option_type, size, size_number, price, display_label,
  applicable_to, min_generation, max_generation, is_active, display_order
) VALUES
  ('ram', '4GB', 4, 3200, '4GB DDR4', 'ddr4', 6, 12, true, 3),
  ('ram', '8GB', 8, 6000, '8GB DDR4', 'ddr4', 6, 12, true, 4),
  ('ram', '16GB', 16, 11500, '16GB DDR4', 'ddr4', 6, 12, true, 5);

-- Insert DDR5 RAM options (12th Generation onwards)
INSERT INTO laptop_upgrade_options (
  option_type, size, size_number, price, display_label,
  applicable_to, min_generation, max_generation, is_active, display_order
) VALUES
  ('ram', '4GB', 4, 5000, '4GB DDR5', 'ddr5', 12, NULL, true, 6),
  ('ram', '8GB', 8, 8000, '8GB DDR5', 'ddr5', 12, NULL, true, 7),
  ('ram', '16GB', 16, 15000, '16GB DDR5', 'ddr5', 12, NULL, true, 8),
  ('ram', '32GB', 32, 28000, '32GB DDR5', 'ddr5', 12, NULL, true, 9);
